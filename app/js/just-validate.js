...
(function (root) {
  ...
  function resolve(self, newValue) {
    try {
      ...
      if (
        newValue &&
        ((typeof newValue === "undefined" ? "undefined" : _typeof(newValue)) ===
          "object" ||
...
(function (window) {
  ...
  JustValidate.prototype = {
    ...
    defaultMessages: {
      ...
      remote: "Электронная почта уже существует",
      strength:
        "Пароль должен содержать по крайней мере одну заглавную букву, одну строчную букву и одну цифру",
